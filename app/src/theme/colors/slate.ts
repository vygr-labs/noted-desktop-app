...
export const slate = defineSemanticTokens.colors({
	...
	a6: { value: { _light: '#00002f26', _dark: '#d7e8fd30' } },
	a7: { value: { _light: '#00062e32', _dark: '#d4e5fe3e' } },
	a8: { value: { _light: '#00083046', _dark: '#d5e4fd57' } },
	a9: { value: { _light: '#00051d74', _dark: '#d7e3fd6a' } },
	a10: { value: { _light: '#00071b7f', _dark: '#dae2fd78' } },
	a11: { value: { _light: '#0007149f', _dark: '#e4eaffb5' } },
	a12: { value: { _light: '#000509e3', _dark: '#eef1fef0' } },
	solid: {
		bg: {
