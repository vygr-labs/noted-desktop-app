...
// Frontend mirror of src/backend/export/tiptap-to-markdown.ts. Kept in the
// renderer so selection-scoped conversions (the editor's "Copy as Markdown"
// context menu) can run synchronously without an IPC round-trip. Behaviour must
// stay in sync with the backend copy used by note export.
